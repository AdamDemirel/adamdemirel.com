...
Motivational characteristics encompass characteristics of the job which are related to the nature of the work itself, and a result, how that affects the worker. The original model is called the Job Characteristics Model and is the most widely studied, oldest, and strongly supported theory in job satisfaction.

“The most consistent predictor of job satisfaction is mentally challenging work (2) - derived via meetin te JCM” ( https://80000hours.org/2012/08/how-to-find-a-job-you-ll-love/ https://80000hours.org/2012/08/don-t-do-what-you-re-passionate-about-part-2/ ) ("http://www.timothy-judge.com/c06.pdf Judge, T. A., Klinger, R. (2009). “Promote Job Satisfaction through Mental Challenge”. Handbook of Principles of Organizational Behaviour, Second Ed, pp107-119)

There is widespread agreement that the job characteristics model below is the strongest predictor of what constitutes a satisfying job above and beyond all oter factors. Of all the variables correlated with job satisfaction, all 5 job characteristics correlated with job satisfaction at a high .41.

## Job Characteristics Model

The job characteristics research is one of most well researched approaches and identifies that it is the nature of the job itself, not anything else, that determines how satisfying the job is. The original and withstanding model was developed in 1975 by Hackman and Oldham and proposed five factors which make work satisfying for workers and that make up a satisfaction job:
...
All of these factors together result in high work **engagement**. The more of them you have, the more satisfying the job, irrespective of who is doing the job, where it is, how much it pays, etc. You want a job that engages you because challenge gets you into flow. “the right job according to mihaly C is a job that challenges us to an optimal level - one thats neither so hard that we give up nor so easy that we get bored. finding a job that engages your natural talents and give you constant feedback is a sure way to build happiness.” [ https://signalvnoise.com/posts/104-all-about-flow #]

What's the most interesting about the job charactieristcs model is that noen of it is paticularly relted to the subject matter of the work, a failed bias we are typically drawn to. Instead, what the job is doesnt matter so much as what the factors it has are.

These were all originally measured by what is called the _Job Diagnostic Survey (JDS)_ (reference), a series of questions with a 1-7 scale. The survey that is used to test it is most recently called the Work Design Questionairre, and you can see the questions asked here https://msu.edu/~morgeson/English_WDQ.pdf.

// TODO
does your country determine the effects of job characteristics? https://www.sciencedirect.com/science/article/abs/pii/S0969593115000062

### Autonomy

Autonomy is the freedom that an individual has in carrying out teir work, or the degree to which one has control over how to do a job. In the JDS, it was measured by asking
...
It was later argued (Breaugh 1985, Morgeson and Humphrey 2006) that autonomy wasn't a singular construct like it was being measured oriinally, but was made up of multiple factors that each had their own predictive values. Most important being:

1. Work Scheduling Autonomy - The freedom to control the scheduling and timing of work (Jackson and colleagues same as below)
...
Skill Variety is the extent to which an individual must use different skills to perform at his/her job. It is separate from Task Variety which is the extent to which an individual performs different tasks at the job. Task Identity wasn't originally measured by Hackman but was instead measured in a separate survey called the _Job Characteristics Inventory (SCI)_ in 1976 (sims, szilagyi, 1976).

Both constructs are very similar but have slightly different predictive power. Skill variety focuses on the skills of the worker, whereas the task variety focuses more on the job itself which is more consistent with the other 4 factors of the job characteristics model. As a result of their similarity, they have often been combined together and measured as one construct in popular studies.
...
> How similar are the asks you perform in a typical work day?
...
Task Identity is about the extent to which the outcome of your work is connected to te work tat you do, or about te extent to wic an individual can complete a wole piece of work.

Task identity was meauured by askin:
...
### Task Significance (TS) / Helping Others

Task significance (aka Contribution) is the extent to which your job impacts others lives, or how important you see your job tasks. It's related to how meaningful your work is, or more concretely, how directly and intensely it has an impact on other's wellbeing.

TS was measured in the JCS (jc survey) by asking:
...
Grant, et al. (26) later re-evaluated task signifiance and measured it as:
> My job provides opportunities to substantially improve the welfare of other people
> My job enhances the welfare of others.

He then extended the 4 items by which to measure (26) to test task significance in the JCM, again on a 1-7 scale.

1. Job Dedication (the amount of time and effort expended in completing assigned tasks) and
2. Helping Behaviour (performance review by employer on pro-social behaviour)
3. Perceived social impact, and
...
1 and 2 are outcome measures and demonstrated a causal link btw task signifiance and JS/job performance. Noteworthy is that the JCM assumes task signifiance is a job characteristic, but (26)'s experiments demonstrat that it's a social characteristic instead. How much task signifiance affects job performance and JS is mediated by how much an individual subjectively evaluates their job for 3 and 4.

Work that helps others is also often linked to meaning, and vice versa. An extreme view which potentially captures the dissatisfaction that results from meaningless work is by Erich Fromm:

> I think his work is to a large extent meaningless. Because he his not related to it, he is increasingly part of a big social machinery governed by a big beauracracy, and I think american man subconsciously hates his work very often, because he feels trapped by it, imprisoned by it, because he feels as if he is spending most of his energy for something which has no meaning in itself. He's not dignified in making a life with his work because that's not quite enough to make one happy, if one spends 8 hours a day in something which in itself has no meaning and interest except that one gains money from it. The deeper meaning is for example the creative pleasure in the age of the artisan.
> Task significance is measured with “My job provides opportunities to substantially improve the welfare of guest."

This is a little extreme, but it highlights the concept. Interestingly, there is an organisation called 80000 hours which is related to the effective altruism organisation, and they also do a lot of job satisfaction research summary and career advice. One of the main arguments that they make is that job satisfaction is primarily driven by task significance, and that you should design your career to have the largest social impact that you can to increase your job satisfaction and the world. Although they have gained a lot of popularity recently for various reasons, their argument hinges on how significant task signifiance really is.

Firstly, in regards to motivation, the motivation to do prosocial work is based on the extent to which the nature of your work allows you to interact with those who benefit from it (25) - by frequency, proximity, duration, depth, and breadth of contact. This means that the 80k argument to benefit others indirectly (eg by donating) won't have as large of an effect on your JS as they expect.

But most critical of 80k's mission is that the relationship between Perceived Social Impact, and Perceived Social Worth is moderated by _conscientiousness_ (see dispositional characteristics/big 5), and _pro-social values_.
Conscientiousness negatively mediates the relationship - ie the higher the conscientiousness, the lower the effect of task significance on job performance (due to effective performance and high effort being a reward in itself). And the higher the pro-social values, the higher the effect of task significance on job performance (due to them being more influenced by perceived social value and worth).

#### Pro-Social Values
To measure prosocial values, (27) use the benevolence subscale of the Portrait Values Questionnaire:
...
> close to him.
> It is important to him to respond to the needs of others. He tries to support those he
> knows.
...
Task feedback / also known as feedback from te job, is te extent to wic a job imparts informatiton about an individuals performance. Or roughly, the degree to which the work itself provides feedback of how well one is performing at the job.

Task feedback was measured by askin:

> To wat extent does _doing the job itself_ provide you wit information about your work performance? Tat is, does te actual _work itself_ provide clues about ow well you are doin -- aside from any 'feedback' co-workers or supervisors may provide?

## Growth Needs Strength

Though the job characteristics is a strong predictor of job satisfaction, as a eneral principle - te stronest, the effect of job caracters on job satisfaction was found to be moderated by an individuals needs for growth in what's called the Growth Need Strength. For those high in GNS, the correlation between job characteristics and job satisfaction is very high at an average of 0.57, which is the strongest correlation we have, but for those low in GNS it is .32, which is still quite a strong relationship, but less strong. You can measure your GNS quickly and easily [here](http://highered.mheducation.com/sites/007040187x/student_view0/chapter5/self-assessment_5_6.html). The scale ranges from 12-60, with low growth needs being 12-29, moderate being 30-42, and high being 43-60. My GNS is 32, which is moderate. This means that the correlation is around .44-.53 ? Interestingly, I did the test around one year later, forgetting my previous results, and scored 38 again which is still in moderate, demonstratin its stability.

Wat tis sows is tat altou te JCM is one of te most important factors in determinin wat type of job you sould seek out, you sould weit it slitly less tan oter factors if your NS is low. Put rouly speakin - you need a less enain job to be sastsfied.
...
- Task variety, wic we discussed above
- Job Complexity
...
Job complexity is the extent to which a job is multifacted and difficult to perform. As a result they tend to be mentally demanding. Oddly, although high complexity is expected to increase job satisfaction, it is also more likely to promote stress and feelings of work overload, even if engaging.
...
The third school of thought on what constitutes job satisfaction is that people primarily derive their job satisfaction from the people they surround themselves with. It's established that humans are social animals and are generally positively affected by socialising, making is more energetic, happier, excited, enthusiasm, and it is a fundamental motivation.

Lately, researchers have thought social characteristics via the relationships between workers as being among the most important causes of job satisfaction. This fits with most of our intution that working with people you dislike is terrible. The ways in which social characteristics may influence job satisfaction are many, but the ones that have been noted as potentially important are:

- Social Information Processing: ie conforming to others
- The extent to which the job Deals With Others / aka Interdependence
- Feedback from Others
- Social support
- Interaction Outside the Organisation
- Small Talking
- Being offered friendship opportunities on the job

ie good relationships with your colleagues, from 80k vid series
_use the horsemen from john gottman_, as well as karl venenburgs authentic listening.

## Social Information Processing

Social information processing is the theory that employees look to coworkers to make sense of and develop attitudes about their work. (if your coworkers are [dis]satisfied, so will you be.) As a rivaling theory to JCM, Jex (2002) argues employees look to coworkers to see what their levels of job satisfaction are, and the attitudes they have about their work. If their coworkers attitudes are positive, they will more likely be satisfied, and the converse. This is interesting because new hires can be 'tainted' during the socialization process if placed around dissatisfied employees.

It is less about what job or criteria help in promoting job satisfaction and moreso about the social influences on the perceptions of the job characteristics themselves.

// TODO
Generally the research supports social information processing as having an affect on job satisfaction, but the strength is ?

## Dealing With Others / Interdependence
...
This is about the extent to which other organizational members provide performance information/feedback to an individual, different from the JCM feedback from the job itself.
...
This is the extent to which a job requiries an individual to communicate with people (eg suppliers or customers) external to the organization, ie serving the public.
...
These are expected to influence job satisfaction via being more related to biological concerns for safety and survival.

## Physical Demands / Ease

The extent to which a job involves physical strength, endurance and activity requirements of a job.

## Work Conditions

Work conditions captures aspects of the environment generally, such as health hazards, temperature, and noise.

## Noise

Being exposed to offensive noise while at work only affects job satisfaction by a mere -.04, but has a bigger affect than any other factor on net emotional state while doing the job, at a whopping -.90 correlation. (kahneman 2006 measurement.pdf) This means that noise pollution while working basically makes a job disssatisfying more than any other factor.

## Heat / Cold

I couldn't seem to find any research done directly on job satisfaction.
...
- Unhappy children become dis­
  satisfied workers later in life (Staw, Bell, and Clausen, 1986 ).
- JS is partly eritable (see Arvey, Carter, and Buerkley, 1991 ).
- Different individuals wit te same jobs ave differin levels of JS
- People rate different jobs and employers relatively stably over time
- - prior job satisfaction is a stronger predictor of current job satisfaction than changes in pay or status.
- ref for above : Summary of ch9 'Job Satisfaction - subjective well-being at work' 2008 pp393-413. (from lukeprog happiness references, “job satisfaction is strongly correlated with happiness”) p 401
...
- The Big Five Personality traits - The 5 core personality traits which have been shown to be related to a wide range of different domains and outcomes
- The 4 Core Self-Evaluations
- Positive vs Negative Affectivity (Emotions)

### Genetics
And fourthly, considering the hereditary nature of job satisfaction, these personality traits are believed to be partly genetic and heritable, with genes explaining up to 30% of the variation in job satisfaction (Arvey et al., 1989) (2: https://www.ncbi.nlm.nih.gov/pubmed/27504661). That is, the genes of monozygotic twins (genetically identical) explained .29 correlation with JS, where dizygotic twins (genetically dissimilar) explained -0.02 (28). So it's clear that there's a genetic relationship, but interestingly, the relationship only moderated job characteristics, and not external characteristics such as pay.
...
Related to this is the link between life satisfaction and job satisfaction. Interestingly, it turns out that there is a stronger causal relationship between your happiness on your job, than from your job on your happiness (https://onlinelibrary.wiley.com/doi/abs/10.1348/096317909X478557). Research suggests that life satisfaction often precedes and is a good predictor of job satisfaction.

## The Big Five Personality Traits

The big 5 personality traits are Openness, Conscientousness, Extraversion/introversion, Agreeableness/disagreeableness, and Neuroticism (OCEAN). The Big Five is an extremely respected school of thought in Psychology and carries a huge amount of support and widespread consensus as a model, with predictive power for many many fields, only superseded by the power of IQ. There is a lot to say about it, but a basic intro can be found on wikipedia https://en.wikipedia.org/wiki/Big_Five_personality_traits.

Again, we're curious how this relates to JS. In summary, consciousntess has a consisntetly significant impact on JS, whereas openness has a consciently insignificant effect. The other 3 - neuroticism, extraversion, and agreeableness, have inconscient relationships.

### Openness To Experience

Openness is characterized by intellectual curiosity, and imagination, and non-conforomity. Although importrant for many other fieds, it has little effect on JS - correlating at 0.0. (bui 2017)

### Conscientousness

Conscientousness is an individuals level of organization, hard work, and motivation in the pursuit of established goals. Consciousness is a strong perdictor of job performance and success, more than any other trait. In fact it's more predictive here than literally anything else besides IQ which is the best predictor.

Given that, it may explain why consciouensness is positively related to JS. It seems to have a consisntelty significant impact on JS, and low consciensness results in low JS.

Correlateion isa bout .26 (bui 2017). highly predictive of work performance.
.26 (judge 2008).
...
There appears to be a very strong relation btw extraversion and JS.
The correlation is about .24 (bui 17), .25 (judge 2008).

### Agreeableness

Agreeableness is the level of cooperation (trusting of others) and likeableness of an individual, usually resulting in positive social relationships with others. It's unclear whether it affects JS (bui 2017), but the correlate is around .26

### Neuroticism

Neuroticism is the extent to which an individual lacks positive psychological adjustment and emotional stability. Ie high neuroticism = low emotional stability. It's a little more subtle than that, but the gist is that they are more liekly to experience negative emotions - including anxiety, depression, hostility, etc. (bui 2017)

Neuroticism is believed to have the strongest effect on JS Out of all the big 5 traits, but in a negative mannager, and emotional stability has an inversely positive effect. Though some other research contradicts this.

- correlates -.26 (bui 2017), -.29 (judge 2008)

## Core Self-Evaluations (CSE)

Core self-evaluations are a broad personality concept that encapsulate 4 specific personality traits:

- generalized self efficacy
- locus of control
- self-esteem, and
- low neuroticism / ie emotional stability.

The mechanism on job satisfaction is believed to be mediated by the effect that these personality traits have on the perception of job characteristics. If we have a positive self-regard, we are likely to see our jobs positively and undertake ones that are challenging, and vice versa. The various processes that potentially mediate the relationship are that positive core self-evaluations lead us to both seek out and attain more challenging work, and then further perceive the work as more challenging and interesting after (judge 2000). The individuals with positive CSE are also more likely to work towards goals for reasons consistent with their values ( Judge, Bono, Erez, and Locke, 2005 ) which would make them more satisfied.

Overall, the 4 core traits combined together correlate quite highly with job satisfaction at .41 (judge 2000), or .37 (judge 2008), though the individual traits vary. The measures were all originally devised by Judge et al 1997, and including a 1-5 scale (strongly disagree - strongly agree).
...
Correlates .43 with job satisfaction (judge 2000)
...
Correlates .33 with job satisfaction (judge 2000)

If employees don't believe that they can successfully perform a job, this may results in low job satisfaction, and an organization might want to consider techniques designed to increase employee self-efficacy (eg see Chapter 10 , this volume - org behaviour handbook?)

### Locus of Control

Locus of control is the extent to which an individual believes that he/she has control over events in their life, positive and negative.
...
Correlates .28 (judge 2000)

### Low Neuroticism / Emotional Stability

Neuroticism is the degree to which an individual experiences feelings of irritability, nervousnessn worry, embarassment, or guilt. It is essentially the same as the big 5 neuroticism trait, but measured in a slightly different way.

Measure by asking the individual to rate their level of agreement with statements such as:
...
Affective Disposition is how likely people experienced positive and negative emotions. If you x, you have higher trait negative affectivity, and positive.

Trait Negative Affectivity (.37) is somewhat more strongly correlated (.-37) to job satisfaction than trait Positive Affectivity (.29). (judge 2008)

Though compared to Core Self-Evaluations, Affective Disposition correlates less strongly to JS, explaining less variance.

# 5. Person-Environment Fit

https://80000hours.org/2014/10/interview-holden-karnofsky-on-the-importance-of-personal-fit/ _
https://80000hours.org/2013/04/how-important-is-fitting-in-at-work/

Having a career which is a good 'fit' for their personality is usually extremely high priority for most people. Person-Environment (https://en.wikipedia.org/wiki/Person%E2%80%93environment_fit) fit is the most intuitive of theories around what causes job satisfaction. It is a high-level superset of a few other theories - such as personality-job fit (https://en.wikipedia.org/wiki/Personality%E2%80%93job_fit_theory).

It states that job satisfaction is the result of an individual being in the correct environment - one that matches their interests, preferences, personality, "passions", etc. This is the most intuitive because it fits with a lot of the career advice that is out there - namely that the way to find a satisfying job is to firstly discover your interests and passions, and then to find a job that allows you to do those. - basically, to make sure that you put the right person in the right job.

Tere are few main tests wort mentionin based on teir popularity, and/or merits:
1. Myers–Briggs Type Indicator (MBTI)
2. RIASEC / olland Codes
3. Values In Action (VIA)

Although these are not perfect approaches, I think they are better than systematically going through an  uncategorized [list of jobs](https://joboutlook.gov.au/A-Z) and trying forecast what you would and wouldn't enjoy, as people ave a [poor ability](https://80000hours.org/2012/09/do-you-really-know-what-job-will-make-you-happy/) at predictin wat will make tem appy. It could be potentially wort explorin in te cance of findin a career full of tasks tat you love to do.

## Myers–Briggs Type Indicator (MBTI)

A very crude approach of how this could be done is something like te extremely popular Myers Briggs personality test wic most of us ave eard of or taken. It gives you your 4 letter personality type, such as "INTJ", and then lists a bunch of careers at which those personality traits excel, [like](https://www.16personalities.com/intj-careers) this  or [this](http://www.truity.com/personality-type/INTJ/careers).

Although the MBTI jives with a lot of our intuitions, it has very low validity and teres a 50% cance tat you will et a completely different result if you retake te test 3 monts later (ref?). Also, if you are a teenager, research [suggests](https://digest.bps.org.uk/2019/01/21/teenagers-lack-of-insight-into-some-of-their-abilities-has-implications-for-career-counselling/) that you have a lack of insight into some of your abilities (what you are good and bad at) and this can have implications for trusting your intuitions over the career that you pick.

## RIASEC / Holland Codes

Stronger and much more supported is the Holland Code Test, aka the RIASEC wic tries cateorized people into 6 different types, bein:

- Realistic/Doers
- Investigative/Thinkers
- Artistic/Creators
- Social/Helpers
- Entreprising/Persuaders, and
- Conventional/Organizers

It is again a similar concept to the MBTI where you divide people up into 6 neat types and then you find jobs that those types like to do. Although it seems almost too convenient, there is research that it works to some extent - with an establised 0.21 correlation with job performance (nye et a 2012). And that correlation makes sense if you consider that jobs are grouped into what type of tasks they involve, and that perhaps people can be divided into the types of tasks they love to do.

Unfortunately te paper referenced above is only interested in job performance and not job satisfaction ere so we cannot see wat we want directly. Tou tere is a stron correlated between job satisfaction and job performance, so we can potentially use it as a proxy. Te paper (nye et al) concluded:

> Last, more research is needed on the relations between vocational interests and other important criteria (e.g., job satisfaction)

Altou tere is a lare amount of researc supportin te idea tat te 6 different types are valid and do exist, its relation to JS is more sparse and inconsisntent. But te findins are tat its relationsi can rane anywere from .15 all te way to .54 (32) ! ow muc you can trust tis is questionable.

A more robust meta analysis of 9000 individuals found only a .1-.2 correlation wit JS (http://www.sciencedirect.com/science/article/pii/S000187919991727X).

olland did establis tat people are already motivationally drawn into work environment tat are compatible wit teir interests. Tje question is ow tat relates to JS. e also arued tat JS is unlikely to come merely from makin te work more mentally callenin witout bein personally interested in it, e studyin te law is mentally callenin, but many people ave no interest at all in it. (Holland, 1997 )

I think it worth doing the [free test](https://openpsychometrics.org/tests/RIASEC/) or the [more accurate](http://www.self-directed-search.com/) and perusing the jobs they recommend [here](https://www.onetonline.org/explore/interests/) out of curiosity to help widen your options. Self directed searc is anoter name of te olland test. Tese tests are basically aptitude tests tat take in self-reported personality factors and output a list of careers tt you mit be well suited for. Ten you ave between 6-20 options to researc more in dept for job caracteristics, etc.

Though there is a stronger version of the holland codes called the _Strong interest Inventory_ which correlates 0.27 with job performance (nye et al 2012), and I recommend doing that test instead if you are going to do one.


## Values In Action (VIA) *
A later and potentially more respected approac is into individual 8strents8, most outstandin bein te [VIA](https://en.wikipedia.org/wiki/Values_in_Action_Inventory_of_Strengths) test. It can be taken for free [ere ](https://www.viacharacter.org/personality-assessments)

Te test attempts to measure 24 strents wic are composed of 6 virtues (bold):
...
80000 ours [tink](https://80000hours.org/2016/02/how-important-is-finding-a-career-that-matches-your-strengths/) te strent of te evidence as it results to JS isnt too i, and may be more important for job craftin tan selection - tat is, it may not be useful for pickin a career but may increase your job satisfaction slitly if you utilize your strents in your current job.

Tou I found some more recent researc wic directly looked at te relatonsips. First, it turns out tat different strents corrlate differently wit job satisfaction, wit te most ily bein (33):
- Hope .31
- Zest .30
- Curiosity .15
- Love .08
- ratitude and Spirituality .07, and
- Persistence .06

Tis is a similar list to wic correlate most iliy wit life satisfaciton.

>The 24 character strengths together accounted for 12% of the variance in job satisfaction beyond gender, age, and education.

Another paper which looked at the correlation of all 24 strengths at work found that they only correlate 0.07 (34)

## Fit Is Pickin Wat You Might Excel At
Most of te oter person-environment fit approaces are focused on your interests and preferences and matcin tem wit te job. But a [later scool of tout](https://80000hours.org/2014/10/interview-holden-karnofsky-on-the-importance-of-personal-fit/) is tat fit is about ow likely you are to exceed at your job, and tis could potentially be importrant for JS as perfomin ily in your job can lead to JS.

See the job performing section.
...
If high income were important, you could look at base rates for starting and lifetime income  such as here ( https://www.bls.gov/bls/wages.htm or  https://www.bls.gov/oes/current/oes_nat.htm#00-0000) (ref https://www.lesswrong.com/posts/vADtvr9iDeYsCDfxd/value-of-information-four-examples#Choosing_a_Career) and try to optimize your career based on that. This is a more efficient approach than what most do. But the question is does it increase JS?

Hackman originally noted in the JCM (Hackman, Oldham (1975) Development of the Job Diagnostic Survey.) that if pay is low, job redesign by improving the JCM might fail,
He noted that pay might also be more important if you have lower Growth Needs Strength (hashlink).
...
- How much pay you receive relative to how much you BELIEVE you should receive
- How much pay you receive relative to others doing the same or similar jobs

Both of these moderate whether you think a pay is fair ot not (https://www.sciencedirect.com/science/article/abs/pii/0047272795015647) which influences your satisfaction with it.
...
And finally, related specifically to JS itself, pay level was found to correlate only .15 with job satisfaction (31).
...
As noted many times throughout here, job performance and job satisfaction are tightly linked.

How well you do at your job has a bidirectional effect on job satisfaction - meaning that the more satisfied you are with your job the better you perform, and also the better you perform, the more satisfied you are with your job. Both job satisfaction improves job performance, and job performance improves job satisfaction ([ref from 80k?](https://80000hours.org/articles/job-satisfaction-research/#3-work-youre-good-at)).

80000hours weights this quite heavily and recommends selecting for work that you could excel at. [There may be some rationale to this argument.](https://slatestarcodex.com/2015/01/31/the-parable-of-the-talents/)

## Stress Level

Research shows that low stress jobs dont make you happy, but rather a challenging job. Some stress is bad, some is good. If you have few demands placed on you then its more likely that youll be bored. (consider falafill)

Moderate stress levels are good for satisfaction good for job satisfaction. http://www.rand.org/content/dam/rand/pubs/technical_reports/2005/RAND_TR192.pdf \* resources on improving occupational stress here https://80000hours.org/2016/02/should-you-look-for-a-low-stress-job/ #

## Qualifications

Being overquaified for ones job affects job satisfaction with a -.20 correlation, and affects net emotional state on the job by -.11. (kahneman 2006 measurement.pdf)

If the job you are doing requires specialized education or training, it positively job satisfaction with a .20 correlation, and net emotional state on the job by 0.10 . (kahneman 2006 measurement.pdf)

## Organisation Size

Organisation size also impacts job satisfaction.
...
Also, slightly unrelated to job satisfaction, but quite noteworthy is a set of research called the _whitehall studies_, and what was found was that the larger the organisation, the more stratification there is between classes of workers, and the greater the job stress for those lower (https://en.wikipedia.org/wiki/Whitehall_Study#Explanations_and_Implications).

## Gender

Females are more satisfied with their job than male employees on average (https://www.fwc.gov.au/resources/research/australian-workplace-relations-study/first-findings-report/6-employee-experiences/job-satisfaction-employees). Male employees are more affected by the level and autonomy and control over their work, whereas females are more affected by work-life balance (balancing work and non-work commitments)

## Working Speed / Pressure

If your job requires that you are under constant pressure to work fast, it negatively affects job satisfaction with a -.19 correlation, and affects net emotional state on the job by -.28. (kahneman 2006 measurement.pdf) Does this make hospitality a bad choice? Potentially.

If your job requireed constant attention to avoid mistakes, it affects job satisfaction negatively by only -.04 correlation, but it affects net emotional state on the job by -.13. (kahneman 2006 measurement.pdf)

## Employment Type

Recall that life satisfaction is a global measure of how happy people rate their lives.
It turns out that whether you are employed or not has a strong relation to this. You would think that being able to louze around all day would make you happy, but it turns out that unemployed people are less satisfied with their lives and unhappier than employed (36). People on government bucks also have double the life dissatisfaction of the employed.

So employment makes you happier than unemployment, but self-employment happens to make you very-very slightly less satisfied.

Within those that have regular employment - part time workers have slightly higher life satisfaction and well-being than full-time workers.
...
The conclusion is that being jobless is not the solution to the 80,000hours of work problem. What you want is challenging work that increases JS and life satisfaction - to work on something that you love.

### Hours Worked
As mentioned above, part time workers (<38h/wk) have higher overall life satisfaction than full-time workers (38h+/wk) (37). But they also have slightly higher job satisfaction:
- Part time workers rate their JS are 5.56 / 7
- Full time workers are 5.37 / 7

This fits with our intuition that having time affluence is better for our well-being, but laso contradicts our desire for wealth. It is noted by a lot of JS Models as a 'hygiene factor' - that is, hours worked may only begin to affect JS when the hours become obsessively long.

For a full exploration of the effect of time scarcity on well-being, I recommend the book Happy Money.
...
https://www.nesta.org.uk/report/creative-occupations-and-subjective-wellbeing/)
...
Age does not appear to have any significant impact on JS (bui 2017).

## Commute Time
People who have long commutes are much more miserable than people with short commutes. The fact that people undervalue their commute to work even has it's own name - The Commuting Paradox (29).
...
(same ref as above) If you are travelling by car or private vehicle, those travelling less than 15 minutes each way are happier than those travelling 16min +  by the same method. If you are travelling by bus, those spending more than 30min+ commuting were less happy the latter. If you are travelling by train, there's no adverse effects on well-being up to 30mins compared to those in cars and buses, but after 30 minutes of travel, happiness levels dropped for those travelling by any method. Interestingly, those cycling or walking to work btw 16-30mins had lower happiness than those travelling only 15 mins by any method, but people cycling 30mins or more to work had similar levels of those travelling only up to 15 mins by other methods.

# ESM

The sad news is that almost everything in this article is based on self-report by asking people to rate 1-10 how satisfied they feel with their work - the whole thing or certain aspects of it. Unfortunately there's many issues with doing this that make the validity questionable, but fortunately a lot of independent measures corroborate peoples ratings - eg behavioural effects of high and low JS such as turnover, absenteeism, workplace behaviours correlate highly with JS reports.

In saying that, the gold standard for measurement is the Experience Sampling Method (http://www.tandfonline.com/doi/abs/10.1080/13594320444000137?journalCode=pewo20 ) (ESM) which pages people many times throughout the day to get real-time reports on peoples moods rather than post-hoc ratings which are more tainted. The ESM measures *now and there* not *later and elsewhere*.

Unfortunately there doesn't have been too much research done with this method (though what has [is](https://www.hcs.harvard.edu/~jus/0303/bishay.pdf) interesting). From my elementary search, it seems like theres barely anything done on non-teachers or which jobs are best, or which aspects of the job, only that personality/beliefs have a role. So basically what's been done ignores most job satisfaction research. But I believe the ESM will be the future of how the studies are conducted and is promising to keep an eye on if you're interesting in this stuff.

Daniel Kahneman has done large scale ESM studies though (See 'experienced wellbeing' chapter of Thinking Fast and Slow), which includes the moods of people at work:
...
So there we have it, X total variables of potential interest to job satisfaction. That's a whole lot of information to take into account when selecting for how you might spend 80,000 hours of your life, and a whole lot of complexity, contradictors, ambiguities, personal differences, and weights to take into account. How to even begin thinking about this? Hopefully this research summary was a start.

The best paper I came across in this whole process was the 2007 paper by Humphrey and Nahgrang that meta-analysed 260 different studies, including 220k participants, and looked at 14 work characteristics (sections 1-3 here). I've listed them below and due to the large sample size and inter-comparisons, I would trust the validity of these more than most of the others. They found it explained beyong 55% of the variance in job satisfaction which is basically the most we can get at this point. What that means is that if you took 2 random people with different lives, personalities, and jobs, you could basically predict about 50% of what their job satisfaction would be by looking at these 14 variables.

Those 14 work characteristics (1,0 below) include the Motivational Characteristics (which explained 17% of JS variance), Social Characteristics (which explained 17%), and Work Context (mere 4%).
...
* all dot points link to the appropriate sections.
1. Overall Job Satisfaction Measure .85
2. Work Characteristics
   1. Motivational Characteristics x
      1. Job Characteristics Model .41 (GNS: High .57; Mid .44; Low .32) x
         1. Autonomy .50 x
            1. Work-Scheduling .11 x
            2. Decision-Making .58 x
            3. Work Methods .34 x
         2. Skill Variety .46 x
         3. Task Variety .56 x
         4. Task Significance .43 x
            1. Pro-Social Values + x
            2. Conscientousness - x
         5. Task Identity .32 x
         6. Feedback From The Job .45 x
      2. Job Complexity .52 x
      3. Information Processing .42 x
      4. Specialization ? x
      5. Problem Solving ? x
   2. Social Characteristics x
      1. Social Information processing ? x
      2. Social Support .59 x
      3. Feedback from Others .45 x
      4. Interdependence .36 x
      5. Interaction Outside the Organisation .08 x
      6. Small Talking .04 x
   3. Work Context x
      1. Ergonomics ? x
      2. Physical Demands -.08 x
      3. Work Conditions .39 x
      4. Other x
         1. Heat / Cold ? X
         2. Noise ? X
         3. CO2 / Air Quality ? X
...
4. Person-Environment Fit x
   1. MBTI ? x
   2. RIASEC / Hollands .10-20 x
   3. VIA ? x
      1. Hope .31 x
      2. Zest .30 x
      3. Curiosity .15 x
      4. Love .08 x
      5. Gratitude & Sprituality .07 x
      6. Persistence .06 x
5. Other
   1. Income .15 x
   2. Low Job Status -.23 x
   3. Job Performance ?
      1. Bidirectional x
   4. Stress Level ? x
      1. Moderate Stress > High/Low x
   5. Overqualified -.20 x
   6. Specialized Education .20 x
   7. Organisation Size ? x
      1. 5-19 employees > 20-199 > 200+ x
   8. Gender ? x
      1. Females JS > Males x
   9.  Fast Working Speed -.19 x
   10. Constant Attention Required -.04 x
   11. Employment Type ? x
       1.  Part-Time > Full-Time > Self-Employed >  Unemployed/Gov x
   12. Creative Occupations ? x
       1.  Creative > Non-Creative x
   13. Sleep Quality ? x
   14. Age .0 x
   15. Commute Time ? x
       1.  <15mins time best x
       2.  61-90mins+ time worst x
       3.  Up to 15mins any mode best x
       4.  Cycling/Walking > Train/Car/Bus x

# Application \*****

So how can we take this dump of data and try to find actionable insights in it?
Since as we discussed each variable has the possibility of facilitating job satisfaction or job dissatisfaction, our best bet statistically is to commonsensically weight heaver which correlate more, and weight the variables less which correlate less.

Lets get the uncontrollable variables out of the way. When trying to increase job satisfaction, your age is not at all relevant, so do not use that as an excuse. If you are a female, you are lucky in that you are statistically slightly more likely than your male counterpart to be satisfied with your job. How much attention your job requires is also negligible, and that's basically it. The rest is within your circle of control.

Although you would think your genetics are chance, which they are, they are expressing their affects on your JS predominantly through your personality, which I'll discuss shortly.

As for unknowns - who knows whether the ergonomics, temperature, CO2 / air quality level, noise level, job specialization, or problem solving affects JS. The best thing we can do here is to experiment with it ourselves and make subjective ratings during those days, or to hold on for better studies in the future. It is unknown to what *extent* sleep affects JS but it almost certainly does in some way. The same for stress level, but good stress is different from bad stress. Also, your job satisfaction may be mediated by conforming to the evaluations are you (social information processing), but its hard to know by how much.

Also the correlate between small talking on the job, physical demands of the job, and interacting with outside of the organisation are so small that they are not worth paying attention to. Creative jobs are also slightly more satisfying than non, but not so much that you should weight it highly.

Now for the cream of the crop: what actual job should you select for?

The most important take away that I haven't highlighted yet is the strength of correlation that Social Support received - a whopping .59, even more than JCM. Recall that social support is a measurement of how assisting your supervisors and coworkers are. How this affects us is that making sure that you like the people that you work with will have the largest effect on whether you will likely find your job satisfying or not, so make sure to get this one right. Obviously you won't know the people in your organisation until you work there, but you should keep this knowledge in your mind to weight each job that you try. This criteria is starting to be acknowledged by many orgs and they are referring to it as "culture fit".
...
As we saw, the JCM are highly important for JS and will be the main metric by which you weight different jobs. I'll remind you that you should take the GNS to figure out how much you should weight it for assessing different jobs. It only takes about 2 minutes.
...
I did find one paper (38)  which measured global JS across 50k participants and found the following:

![jsjobs](jsjobs.png)

Which is interesting and indicative, but I wouldn't weight it *too* highly.
...
I think a better approach to filtering jobs is to start with your passions, interests, and strengths, even if not perfect, and then filter by JCM and job complexity. I would weight job complexity and JCM about equally as highly. So the more complex the job, the better.
...
Then once you have a list, I would email, talk to, meet, interview, etc, as many people that you can from those jobs and try to assess to the best of your ability how they rank on the JCM - potentially even using the direct questions from the surveys, and also on job complexity and information processing. As for weighting the JCM - as you saw, weight decision-making autonomy the highest, equal with task variety, and then skill variety/feedback from the job second. It might be worth doing the pros-social values test and its definitely worth doing the big 5 test, and use both the pros-social values and conscientousness to weight task signifinance of the job. If you are low in conscientousness or pro-social values, then you shouldn't weight task signifiance highly at all, as having a social important won't be as important to you as engaging work will be in and of itself. Task identity can be weighted pretty low.
...
* That you preferably get to interact with others inside the organisation as a part of your job / Interdependnece (weight this more highly than the previous)
* That you get social feedback from others for the work you're doing
* You're performing well

Besides all of that, the only other thing you should weight in your job is the size of the organisation, which should ideally be <20 people.
...
* Quickly [do](http://highered.mheducation.com/sites/007040187x/student_view0/chapter5/self-assessment_5_6.html) the Growth Needs Strength to see how much to weight the JCM
* Weight decision-making autonomy and task-variety the highest in job characteristics, followed by job-complexity, then skill-variety, task significance, feedback from the job, and lastly identity
...
https://pdfs.semanticscholar.org/e47e/797a026069ebce49ce95c7290406ed782ae9.pdf
Hackman, J. Richard; Oldham, Greg R.
m The Job Diagnostic Survey: An Instrument for the
Diagnosis of Jobs and the Evaluation of Job Redesign
Projects.
...
Grant, A. (2008). The significance of task significance: Job performance effects, relational mechanisms, and boundary conditions. Journal of Applied Psychology, 93(1), pp.108-124.  # (googled task significance job satisfaction)

Allan, B., Duffy, R. and Collisson, B. (2016). Task Significance and Performance. Journal of Career Assessment, 26(1), pp.172-182. # (googled task significance job satisfaction)
...
26 ) Grant, A. M. (2008). The significance of task significance: Job performance effects, relational mechanisms, and boundary conditions http://selfdeterminationtheory.org/SDT/documents/2008_Grant_JAP_TaskSignificance.pdf

1.  27> Schwartz, S., Melech, G., Lehmann, A., Burgess, S., Harris, M. and Owens, V. (2001). Extending the Cross-Cultural Validity of the Theory of Basic Human Values with a Different Method of Measurement. Journal of Cross-Cultural Psychology, 32(5), pp.519-542.

2)  28> https://sci-hub.se/https://doi.org/10.1016/0191-8869(94)90258-5
...
32> https://www.webcitation.org/6UBlH5yen

33 > Heintz, S., & Ruch, W. (2019). Character strengths and job satisfaction: Differential relationships across occupational groups and adulthood. Applied Research in Quality of Life. doi:10.1007/s11482-018-9691-3

34 >  My Better Self: Using Strengths
at Work and Work Productivity,
...
38> http://www-news.uchicago.edu/releases/07/pdf/070417.jobs.pdf
