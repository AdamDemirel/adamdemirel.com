...
Epicureanism ([ref](https://ebooks.adelaide.edu.au/e/epicurus/menoeceus/), [ref](http://classics.mit.edu/Epicurus/princdoc.html), [ref](https://philpapers.org/rec/COOETC-5)) is the school of thought founded on the writings of the individual [Epicurus](https://en.wikipedia.org/wiki/Epicurus). He is considered a **Hedonist**, an important term which frames the position I'm arguing for. The pop culture usage of the word hedonism usually refers to _decadent hedonism_, which is more related to the indulgence of Cyrenaicism as you will see. A lot of scholars effortfully defend Epicureanism from falling under this same label, and have done so by calling him a _negative hedonist_ - negative meaning a focus on the removal of pain rather than addition of pleasure.
...
| -             | Lack of personal space / [proxemics](https://en.wikipedia.org/wiki/Proxemics)                                                                      |                                                                           |
| -             | Missing somebody                                                                                        |                                                                           |
| -             | [Guilt](http://mindingourway.com/replacing-guilt/) and shame                                                                                         |                                                                           |
| -             | Self Loathing                                                                                           |                                                                           |
| -             |                                                                                                         | Laughter / Humor                                                          |
...
| -             |                                                                                                         | Being in nature                                                           |
| -             | Anxiety, [fear](https://www.youtube.com/watch?v=ewU7Vb9ToXg&t=1723s)                                                                                           |                                                                           |
| -             | Regret                                                                                                  |                                                                           |
| -             |                                                                                                         |                                                                           |
...
In fact, hedonistic philosopher Fred Feldman wrote a [great book](https://www.oxfordscholarship.com/view/10.1093/019926516X.001.0001/acprof-9780199265169) which does an extremely good job defending this view of hedonism against every counter argument that you can think of. He refers to mental pleasures/pains as _attitudinal pleasures/pains_ because they are attitudes you have about the world - a very philosopher way to describe things (they often talk about '[propositional attitudes](https://en.wikipedia.org/wiki/Propositional_attitude)'). Besides that, he shows that any alternative to hedonism you can think of is simply nonsense when compared with it. Anything you describe as valuable, whether that be knowledge, love, aesthetics, etc, can be captured under the idea of positive and negative experiences and therefore it is only rational to be a hedonist, in the sense of wanting to maximize good and bad emotions. To demonstrate the positivity or negativity of a stimuli, all that is required is to do is to compare them side by side and choose which is more preferable, which will always be the positive ([ref](https://www.ncbi.nlm.nih.gov/pubmed/12240693)).
...
Most interestingly, the better predictor of your wellbeing and happiness isn't the intensity of positive experiences, but rather the frequency and duration ([ref](https://link.springer.com/chapter/10.1007/978-90-481-2354-4_10), [ref](https://hbr.org/2012/01/the-science-behind-the-smile)). But we will still cover the intensity below.
...
Research also supports that one of the reasons wealthier people are less happy is due to lower savoring ability ([ref](https://www.ncbi.nlm.nih.gov/pubmed/20483819)), and that the more abundant life experiences one has had (eg the more one has travelled) the less likely they are to savor ([ref](https://www.ncbi.nlm.nih.gov/pubmed/25583943)). And Easterners tend to savor less than westerners ([ref](https://www.ncbi.nlm.nih.gov/pubmed/21910543)).
...
- **[Leisure Satisfaction](https://en.wikipedia.org/wiki/Leisure_satisfaction)**: Being satisfied with how you spend your leisure time ([ref](https://www.tandfonline.com/doi/abs/10.1080/11745398.2010.9686871))
...
- **Home Ownership** ([ref](https://www.jstor.org/stable/24719087)). It's more important for females than males. However its effect on LS seems to depend on _income level_ - with home ownership being less important for lower income groups, potentially due to 'aspiration preferences' ([ref](https://www.researchgate.net/publication/254420231_Homeownership_and_subjective_well-being)). Some seemingly better research suggests that homeownership improves _housing satisfaction_ but not LS ([ref](https://link.springer.com/article/10.1007%2Fs11205-010-9607-6)) and that they might actually not be happier at all due to spending their time in worse ways ([ref](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=1877163)). Also having a **home loan** has a negative effect on LS ([ref](https://www.jstor.org/stable/24719087)).
...
Though remember that this doesn't make pleasure _completely_ valueless, as you are still experiencing pleasure or LS prior to returning to baseline.
...
A perfect way of measuring instant utilities moment to moment was fantasized as early as 1880 by [Francis Edgeworth](https://en.wikipedia.org/wiki/Hedonimetry), in what he called the "[Hedonometer](https://en.wikipedia.org/wiki/Hedonometer)". Fortunately now we have developed instruments which could do this, and many studies have done so ([ref](https://www.jstor.org/stable/2951240)). One way that instant utility is measured is by giving subjects a handle that they can move up or down which indicates their experience from "very unpleasant" to "very pleasant" in real-time.
...
Unfortunately, although that works in specific lab settings ([ref](https://inequality.stanford.edu/sites/default/files/media/_media/pdf/Reference%20Media/Kahneman_2006_Measurement.pdf)), to measure experienced utility over one's whole life, a continuous recording of experience is unfortunately impossible - a person cannot live normally while constantly reporting their experiences.

The closest alternative is the **[Experience Sampling Method](https://en.wikipedia.org/wiki/Experience_sampling_method)** (ESM), which Mihaly Csikszentmihalyi (the dude that also created the theory of _flow states_) invented. What he did was give people diaries or pagers and then pinged them at several random times during the day (or more recently vibrated peoples phones). When he pinged them, they would report what activity they were currently doing when they were interrupted, who they were with, and how they felt (using a 0-6 rating scale of the presence/absence of various feelings - happiness, tension, anger, worry, pain, engagement, and more). Using this ingenious method we could get a direct measure of how people were _currently_ feeling whilst doing various activities. With large enough datasets which can begin to find correlations which give support to the conclusion that certain activities are associated with pleasurable and painful states.
...
Unfortunately ESM studies are expensive, involve high levels of effort from the subjects, and provides little information about uncommon or brief events which are rarely sampled. A new and more efficient mix approach between the ESM and Remembered Utility reports is the **Daily Reconstruction Method** (DRM) where subjects revive memories of the previous day and construct a sequence of episodes in a diary, then describing when the episodes began and ended, how they felt during each episode, who they were with, what they were doing, etc ([ref](https://www.ncbi.nlm.nih.gov/pubmed/15576620)). The ESM is still the gold standard to which the DRM must be compared.

Results suggest that despite relying on a day old memory, the DRM reproduces results of the ESM accurately and is an efficient approximation in _place_ of the more tedious ESM ([ref](https://www.ncbi.nlm.nih.gov/pubmed/15576620)). So it turns out that remembered utilities are not completely inaccurate, but become more so the longer the episode of time evaluated. Although it is still not practical to apply this to your personal life as it took participants 45-75min to complete a DRM report.

## Findings

Applications of the ESM and DRM have unfortunately been limited due to them being difficult to implement in large sample sizes, but some studies have been done. These gives some interesting results - as what you would expect is that how people feel moment to moment would be the same as how people remember feeling, but this is not the case. So the research finds the following ([ref](https://www.ncbi.nlm.nih.gov/pubmed/15576620)):

### General

- People report basically the same profiles for painful experiences (eg dipping their hands in cold water) ([ref](https://inequality.stanford.edu/sites/default/files/media/_media/pdf/Reference%20Media/Kahneman_2006_Measurement.pdf)), which includes their duration neglect
- Many people report themselves in at least a moderately good mood most of the time, negative affect is reported only 34% of the time ([ref](https://philpapers.org/rec/KAHLAT)). Negative emotions are relatively infrequent and mild, and the total absence of positive emotions is rare.
- Negative emotions are the most pronounced in the morning and fall for most of the day ([ref](https://www.ncbi.nlm.nih.gov/pubmed/15576620)), [ref](https://science.sciencemag.org/content/333/6051/1878)), with positive emotions reaching a peak around noon and evening ([ref](https://www.ncbi.nlm.nih.gov/pubmed/16637757))
- No suprise, people are happier on weekends ([ref](https://science.sciencemag.org/content/333/6051/1878)) (except the very poor)
- People spend about 47% of waking hours ruminating, and that ruminating typically makes them unhappy ([ref](https://www.ncbi.nlm.nih.gov/pubmed/21071660), [ref](https://www.ncbi.nlm.nih.gov/pubmed/28191992)), and people would actually prefer to electric shock themselves instead of being alone with their thoughts ([ref](https://www.ncbi.nlm.nih.gov/pubmed/24994650))
- Reported sleep quality explains a very large 56% effect of the difference in positive/negative affect btw people (.3 correlation), a strong effect also seen on life satisfaction - with those who reported 'very good sleep' having a mean net affect of 4.05/6 over the day vs 2.80/6 for those with 'very bad' sleep.
- Personality and temperament also have similarly large effects, similar again to LS
- As with life satisfaction, age and education have very little correlation with net affect ([ref](https://inequality.stanford.edu/sites/default/files/media/_media/pdf/Reference%20Media/Kahneman_2006_Measurement.pdf))

### What We're Doing

- According to ESM research, people are happiest (in order) when making love, exercising, or socializing. Followed by taking a walk ([ref](https://digest.bps.org.uk/2016/10/21/walking-lifts-your-mood-even-when-you-dont-expect-it-to/)), listening to music, eating, meditating, preparing food, childcare, relaxing, reading, and then watching TV ([ref](https://news.harvard.edu/gazette/story/2010/11/wandering-mind-not-a-happy-mind/), [ref](<http://www.danielgilbert.com/KILLINGSWORTH%20&%20GILBERT%20(2010).pdf>)). Some older DRM research puts the order as: making love, socializing, relaxing, meditating, eating, and exercising ([ref](https://www.ncbi.nlm.nih.gov/pubmed/15576620)). Some other research puts the order as making love, socializing after work, relaxing, dinner, lunch, exercising, meditation, socializing at work, and watching TV [ref](https://www.aeaweb.org/articles?id=10.1257/089533006776526030).
- According to ESM research, people are unhappiest (in order) when working, using a home computer, commuting, grooming, listening to the news, and doing housework ([ref](https://news.harvard.edu/gazette/story/2010/11/wandering-mind-not-a-happy-mind/), [ref](<http://www.danielgilbert.com/KILLINGSWORTH%20&%20GILBERT%20(2010).pdf>)). Some older DRM research puts the order as: commuting being the worst, followed by working, housework, computer, childcare, using their phone, preparing food, shopping ([ref](https://www.ncbi.nlm.nih.gov/pubmed/15576620). Some other research puts the order as morning commute, working, evening commute, childcare, housework, home computer, shopping, cooking, phone, and watching TV [ref](https://www.aeaweb.org/articles?id=10.1257/089533006776526030)).

### Who We're With

- Of all of our interaction partners, we experience positive affect from highest to lowest with: friends the highest, then relatives, spouse/SO, children, clients/customers, coworkers, boss, and alone. So being alone or with our boss is the worst, with our friends, family, and significant other the best ([ref](https://www.ncbi.nlm.nih.gov/pubmed/15576620))), but either way socializing with our friends and family is imperative to our wellbeing ( [ref](https://www.semanticscholar.org/paper/Happiness-in-Everyday-Life%3A-The-Uses-of-Experience-Cs%C3%ADkszentmih%C3%A1lyi-Hunter/6df0a9929f0e7ab7bb1785368020a2066a8fa200), ([ref](https://www.nature.com/articles/s41562-018-0307-6).
- The mean level of enjoyment on a 0-6 scale was 4.68 for episodes in which respondents socialized with friends, 2.97 when they were commuting alone, and 2.15 when the only activity was interacting with one's boss ([ref](https://philpapers.org/rec/KAHLAT))
- A big suprise is that for American Women the emotional experience of time spent with one's children is slightly less enjoyable than doing housework ([ref](https://www.aeaweb.org/articles?id=10.1257/089533006776526030)), though some research contests this ([ref](https://www.ncbi.nlm.nih.gov/pubmed/23201970))
- _passively_ using social networking sites (fb, ig, twitter) has a negative relationship with affective states (by provoking social comparisons and envy), whereas _actively_ using them has a positive relationship (by stimulating feelings of social connection) ([ref](https://psycnet.apa.org/record/2017-02210-009))
- Divorced women report slightly more positive affect (in comparison to slightly higher life satisfaction for married women)
- Smartphone use diminishes the wellbeing benefits of socializing with friends and family, resulting in us feeling more socially disconnected, distracted, having a lower sense of meaning, and having less net affect. It also reduces the likelihood we will interact with strangers which has well-being benefits ([ref](https://journals.sagepub.com/doi/abs/10.1177/0963721419847200)). Though when the immediate social environment is uncomfortable, or hostile, or there are no opportunities for social interaction, smartphone use should on average increase wellbeing, by acting as a buffer against social exclusion.

### Other

- Facebook use predicts decline in both experienced utility and remembered ([ref](https://www.ncbi.nlm.nih.gov/pubmed/23967061))
- Household income have a modest influence on positive emotions which shrinks in controlled studies, much less of an effect than is seen with life satisfaction ([ref](https://www.ncbi.nlm.nih.gov/pubmed/15576620), [ref](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2944762/), [ref](https://www.ncbi.nlm.nih.gov/pubmed/20565185), [ref](https://www.pnas.org/content/107/38/16489)), with plateauing effects on positive affect at 60k USD (as opposed to 95k USD for life satisfaction), but note that this varies by country see the ref for more details ([ref](https://forum.effectivealtruism.org/posts/dvHpzesXtZAMFSTk3/giving-more-won-t-make-you-happier), [ref](https://flightfromperfection.com/files/post_attachments/jebb_et_al_2018.pdf)). So the correlation for affect is weaker at .17 as opposed to a strong .44 for life satisfaction ([ref](https://plato.stanford.edu/archives/fall2011/entries/happiness/#Sources)). And the correlation btw income and net affect over the day was only 0.05 ([ref](https://philpapers.org/rec/KAHLAT))
- The effects of religion is similar to above, but shrinks less
- Not suprisingly, depression (measured by the indicator "trouble maintaining enthusiasm") is also strongly correlated with daily affect
- Worringly, most of the [job satisfaction correlates](https://adamdemirel.com/job-satisfaction) (such as benefits, training, etc) have less of an effect on the affective experience of a working day, except a few characteristics which include features of the immediate environment, such as _time pressure_, and _opportunity to talk with coworkers_. (2.88/6 mean affect for high time pressure, vs 3.96/6 mean affect for low time pressure - [ref](https://philpapers.org/rec/KAHLAT)). Oddly, even the risk of being laid off doesn't effect affect at work.
- Sadly, in opposition to the adaptive effects of life satisfaction reports for disability, there is no such adaptation for experienced utility and there is a strong negative association btw disability and experienced utility ([ref](https://www.ncbi.nlm.nih.gov/pubmed/26496227))
- Retirees have higher experiential wellbeing than older working adults ([ref](https://www.ncbi.nlm.nih.gov/pubmed/31259585))
- Although people think repeating experiences (such as visiting a museum or restaurant) will be less enjoyable than the first time, that's not the case ([ref](https://www.gwern.net/docs/culture/2019-obrien.pdf))
- Not suprisingly, a headache will make a person miserable
- Business students report more negative affect than others due to more motivation to make money ([ref](https://www.ncbi.nlm.nih.gov/pubmed/17451017))
- On the days when people eat more fruit and vegetables they report feeling more positive emotions, as well as the following day ([ref](https://www.ncbi.nlm.nih.gov/pubmed/23347122), [ref](https://en.wikipedia.org/wiki/Well-being_contributing_factors#Fruit_and_vegetable_consumption))
- Only life events that occurred during the previous 3 months influenced daily affect ([ref](https://www.ncbi.nlm.nih.gov/pubmed/8656337))
- Being exposed to offensive noise is extremely highly correlated (-.90) with net affect at work ([ref](https://inequality.stanford.edu/sites/default/files/media/_media/pdf/Reference%20Media/Kahneman_2006_Measurement.pdf))
- Spending money on others increases positive affect ([ref](https://www.ncbi.nlm.nih.gov/pubmed/22720078), [ref](https://www.ncbi.nlm.nih.gov/pubmed/24769739), [ref](https://www.ncbi.nlm.nih.gov/pubmed/18356530), [ref](https://www.ncbi.nlm.nih.gov/pubmed/20460419), [ref](https://www.ncbi.nlm.nih.gov/pubmed/23421360)), but with more benefit when spending money on strong social ties (friends, lover, or family) than weak social tissues (acquantances) ([ref](https://www.ncbi.nlm.nih.gov/pubmed/21347326)).
- People enjoyed their conversations more when they talked less ([ref](https://www.ncbi.nlm.nih.gov/pubmed/27438475))
- Individuals who prioritized time over money reported more frequent positive emotions ([ref](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6750911/))
...
In terms of the effects of personality, a striking observation is that about half of the participants reported going through an entire day without experiencing an unpleasant episode, whereas a significant minority experienced considerable emotional distress and pain for much of the day (([ref](https://www.aeaweb.org/articles?id=10.1257/089533006776526030))). It appears that a small fraction of the population does most of the suffering - whether because of physical or mental illness, an unhappy temperament, or the misfortunes and personal tragedies in their life.
...
But there is a third method called Expected Utility, or **Predicted Utility** ([ref](https://psycnet.apa.org/record/1990-97854-017)) which I'll cover here for completion. Although not used formally to try to accurately measure well-being over an episode like we were interested in with the other two, it is used a frequently by people everyday to make choices about the future.

Predicted Utility is where we predict _before_ an episode how much positive affect and negative affect it will result in. As you would expect, this is basically what we are doing most of the time when we think about events in the future and whether we should pursue them or not, and it is how we make a lot of major decisions.

A lot of research in this area came about due to the efforts of the Psychologist [Daniel Gilbert](<https://en.wikipedia.org/wiki/Daniel_Gilbert_(psychologist)>), who aptly labeled the field [Affective Forecasting](https://en.wikipedia.org/wiki/Affective_forecasting), and covered a lot of the research in his fascinating book _Stumbling on Happiness_ (SOH) which a most of the research below is derived from.
...
But the most important reason that our brains constantly churn out these predictions is so that we can spare ourselves the hard lessons of experience, whereas other animals must _experience_ an event in order to learn about its pleasures and pains but by predicting. By doing this - we can _control_ our future. And the reason is because humans crave control over their future ([ref](https://www.ncbi.nlm.nih.gov/pubmed/11554650)), and if they lose their ability to control things at any point in their lives they become unhappy, helpless, hopeless, and depressed ([ref](https://psycnet.apa.org/record/1992-98227-000)).

We _should_ want to control our experiences because some futures are better than others, and we try to predict which. Unfortunately we are very bad at predicting which, and the future always turns out to be fundamentally different than it appears for the predicting mind. And these biases in predicting the future are why we often fail to know what will make us happy in the future. These failures apply to small decisions, as well as big such as whom to marry, where to work, when to reproduce, where to retire (SOH P85) - and these decisions are based to a large extent on our predicted utility for them ([ref](https://www.ncbi.nlm.nih.gov/pubmed/15012489)).

The main biases that we exhibit when predicting that future reality are the following:

1. Focalism: We don't predict the future as it actually will be.

- We simplify it to a particular image based on a particular memory. In the process - we add in details that weren't in the real memory ("filling in trick"`), and exclude important details that were.
- Your estimated enjoyment of the future is based on the simulated image, not in the reality. We do the predictions so quickly and effortlessly and assume that the predictions are accurate representations of reality when they are made up and usually based on simplified memories
- Our predictions based on memories only include things that DID happen and not the things that DIDN'T happen - which can happen in the future and drastically affect our predicted response

2. Presentism: We predicts that an event in the future will make us feel the way it does while we predict it in the present

- We find it difficult to imagine that we will ever think, want, or feel differently than we do today ([ref](https://www.ncbi.nlm.nih.gov/pubmed/23288539))
- We compare the future to the past instead of generating new possibilities, but even if we do that we still make errors because we compare it to our current situation rather than our future situation

3. [Impact Bias](https://en.wikipedia.org/wiki/Impact_bias): Positive and negative events don't last as long or effect us as much as we predict them to. This is related to the psychoanalyst Lacan's concept of [Jouissance](https://www.lacan.com/forced.htm) - where we get a milder "jouissance obtained" in place of the full satisfaction of a "jouissance expected" - so attaining pleasures or fulfilling our desire is never as great as we expect.

Some interesting research that demonstrates these 3 biases are:

- People seem to overestimate the effects of past events on their happiness ([ref](https://psycnet.apa.org/record/2004-13408-002)), which may explain errors in prediction
- As mentioned, we base our predictions on our memories, but the memories we base them on are the atypical memorable ones rather than the representative ([ref](https://www.ncbi.nlm.nih.gov/pubmed/16102065))
- Losses do not actually loom larger than gains like we predict ([ref](https://www.ncbi.nlm.nih.gov/pubmed/16913944))
- We receive greater utility from segregating a pleasure into smaller pleasures (eg spreading it over time), but only to an extent ([ref](https://www.ncbi.nlm.nih.gov/pubmed/17999580))
- People enjoy interacting with outgroups more than they expect ([ref](https://www.ncbi.nlm.nih.gov/pubmed/18211176))
- Thinking about the absence of a positive event from one's life (eg imagining that they never met their romantic partner) improved their affect and made them appreciate more than the presence of a positive event (eg thinking about how they met their partner) ([ref](https://www.ncbi.nlm.nih.gov/pubmed/18954203))
- People expect to be pleased by punishing/revenging against an offender, but they feel worse ([ref](https://www.ncbi.nlm.nih.gov/pubmed/19025285))
- Having extraordinary experiences are enjoyable in the moment but leave you feeling worse after than only having had ordinary experiences instead ([ref](https://www.ncbi.nlm.nih.gov/pubmed/25274582))
- People predict to be more happy with changeable decisions than unchangeable, but it's the opposite ([ref](https://www.ncbi.nlm.nih.gov/pubmed/11999920))
- People place greater weight on the physical features rather than social features of future housing, demonstrating the impact bias ([ref](https://www.ncbi.nlm.nih.gov/pubmed/15189579))
- People fail to predict how much they will enjoy exercise due to the unpleasant beginning of it ([ref](https://www.ncbi.nlm.nih.gov/pubmed/21299296))
- People fail to predict the mood benefits of positive self representation (eg putting your best face forward) in social interactions, especially with their romantic partner, and also how good they would feel after being judged positively by others ([ref](https://www.ncbi.nlm.nih.gov/pubmed/17547484))
- People fail to predict the effect of their own personalities on their future affect ([ref](https://www.ncbi.nlm.nih.gov/pubmed/21078898))
- And people enjoy thinking about the absence of positive life events more than the absence of negative events, but failed to predict this ([ref](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2746912/))

Fortunately, Daniel Gilbert proposes a solution which we've already been relying on: rather than trying to predict what will make us happy in the future which is prone to biases and error, we should instead use others and surrogates and look at those that are _currently_ having the experiences we are predicting about, and see how they feel ([ref](https://www.ncbi.nlm.nih.gov/pubmed/19299622)). Doing this avoids the faults of prediction, and allows people to make remarkably accurate predictions.
...
As we know, pains can either be physical or mental in nature. Fortunately, the ways in which to minimize physical pains (the pains [listed in the chart earlier](https://adamdemirel.com/happiness/#section-9)) are quite obvious, so I'm not going to beat a dead horse. And remember that Epicurus had a focus on minimizing physical pains as well. Most of the pains which are physical are usually about maintaining physical homeostasis - by removing hunger, thirst, tiredness, and avoiding tissue damage. What's _nicer_ about these pains than the mental is that although they can be more intense, they are usually only experienced in the present and are fleeting, resulting in a less cumulative effect on our happiness.

The pains that are of more concern are the mental pains, what the Stoics and Buddhists wanted to eliminate. These can be unfulfilled desires, obstructed goals, an array of negative emotional states, social pains, or any of the other in the [large list mentioned earlier](https://adamdemirel.com/happiness/#section-9).

I think it's very easy to go down the path of the philosophers [Arthur Schopenhauer](https://en.wikipedia.org/wiki/Arthur_Schopenhauer) or [Peter Zapffe](https://en.wikipedia.org/wiki/Peter_Wessel_Zapffe) and proclaim what the Buddhists did - that life is constant suffering. It can even be elaborately argued that logically we experience more pains than pleasures, and how pleasures are fleeting but pains quite consistent, or that even if pleasures are good and pains are bad that we always have more pain, etc. This can lead to viewpoints like [Antinatalism](https://en.wikipedia.org/wiki/Antinatalism) which aims to extinguish human sentience to remove the possibility of suffering, or that it's [better to never have been](https://www.goodreads.com/book/show/660518.Better_Never_to_Have_Been) born.

> "There's nothing left to do but find it humorous" - Emil Cioran

In fact, this asymmetry of pleasure/pain probably fits with most people's intuition. Philosopher [Robert Nozick](https://en.wikipedia.org/wiki/Robert_Nozick) had a well-known thought experiment where he prompted people on whether they would get inside a "pleasure (maximizing) machine" - a machine that gives you everything you want and simulates happiness. There's nuances for and against the argument, but the main idea was to critique hedonism as a worthy pursuit. Most people say that they wouldn't get in the machine because it lacks meaning, or isn't real, or some other thing. But I think what might be a more question to ask is whether people would get in a pain minimizing machine - that is, it removes all suffering and the ability to suffer. I would guess that this is likely to be a more attractive alternative to most ([ref](https://en.wikipedia.org/wiki/Well-being#Nagel:_Experience_itself_as_a_good))

I used to even actually empathize with some of the logic in these arguments - in particular I agreed that humans had a *[negativity bias](https://en.wikipedia.org/wiki/Negativity_bias)* where humans had a fundamental asymmetry in how they weighted positive and negative emotions and that it would be more evolutionarily adaptive to experience more negative emotions than positive, as negative emotions help us avoid severe threats to our survival, and that humans evolved to be adaptation executers ([ref](https://www.lesswrong.com/posts/XPErvb8m9FapXCjhA/adaptation-executers-not-fitness-maximizers)) not happiness maximizers. But although this argument seems philosophically persuading, the data consistently demonstrates the humans display a _positivity bias_ rather than a negativity bias ([ref](https://www.nature.com/articles/s41562-018-0307-6)). Regardless of life circumstances and what is happening throughout a day, except under extreme circumstances, individuals generally report high life satisfaction and more positive affect than negative affect. We also remember positive memories longer than negative memories ([ref](https://www.tandfonline.com/doi/abs/10.1080/09658210902791665)) - not _all negativity_, but most, but particularly negative experiences can be magnified in memory.
...
Unfortunately the research actually supports this as we saw - people spend around 47% of waking hours ruminating, and that rumination makes them unhappy ([ref](https://www.ncbi.nlm.nih.gov/pubmed/21071660), [ref](https://www.ncbi.nlm.nih.gov/pubmed/28191992)). That holds even if people are thinking about positive things - it makes them less happy than if we were to be in the present. People would actually prefer to electric shock themselves instead of being alone with their thoughts ([ref](https://www.ncbi.nlm.nih.gov/pubmed/24994650)). "How often our minds leave the present and where they tend to go is a better predictor of our happiness than the activities in which we are engaged".
...
Zapffe argued that there are 4 ways that we can counteract our ruminating mind ([ref](https://philosophynow.org/issues/45/The_Last_Messiah)):

1. Isolation - Isolation is a voluntary dismissal of all conscious thought. This is essentially ascenticism - or what the buddhists and most eastern philosopher's focused on in the form of mindfulness / transcendental meditation. It also looks like this is what Alcohol or depressants do by being a thought-remover in a bottle or pill.
2. Anchoring - Anchoring is whereby we consistently focus our attention on an ideal or goal - whether it be god, the state, morality, travelling, or sport. They're all things that we can anchor our attention to and gives us something to strive towards.
3. Distraction - He thinks that distraction is the most popular in western society as it's the easiest. It's where we limit our attention on thought by bombarding it with information - whether that's consuming music, film, books, socializing, overeating, visual arts, etc.
4. Sublimation - Lastly is sublimation, which is what me writing this essay would be categorized as. It refocuses our mental energy from inward rumination to outward expression in writing, painting, or creating. It requires the most effort and is the most 'productive' per se, but isn't superior to the others and has the same function of eliminating thought.

Unfortunately this model is not evidence based at all and so makes it essentially useless. But it does give us an interesting model. The model is the following: that cognitive reflection is mostly bad for our wellbeing, and that we should go about trying to reduce it. Schopenhauer actually talks about this same thing and calls it the _Sublime_ - which is the loss of self-reflective consciousness ([ref](https://plato.stanford.edu/entries/schopenhauer-aesthetics/#Sub)).

I will say that his premise about the psychological conflict to our death has been supported. Sociologists have research into what's called [Terror Management Theory](https://en.wikipedia.org/wiki/Terror_management_theory) which has a lot of findings showing that humans have a basic psychological conflict resulting from having a desire to live but realizing that death is inevitable. There's also many ways that humans safeguard against this terror - by ignoring it, or building cultural institutions like politics, religion, nations, and sport to counteract the conflict. It supports Zapffe's point that people attempt to avoid their psychological conflict by doing various things.

I don't agree with Zapffe's direct categorization but I do agree that there is a unifying theme here in how humans aim to eliminate mental pains. The instances of that theme are that people drink Alcohol to be in the moment, they meditate and practice mindfulness, they get into _flow_ in various activities (covered further below), and other.
...
[Mindfulness](https://en.wikipedia.org/wiki/Mindfulness) is the process of bringing one's attention to the present moment. As we mentioned, telling people to be present is useless, so what we need to do is have a training system, and as we all know that training system is Meditation. Daily meditation is an effective method of improving the ability to be mindful.

It's been confirmed that meditation is effective at reducing the intensity of pain ([ref](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3090218/)).
...
The mechanism of flow is postulated to be that human attention can only process ~110 bits of information per second. As a benchmark, processing speech takes about 60 bits of information per second. When we go over that limit, we lose awareness of other things as we have no more attention to be allocated to them ([ref](https://books.google.com.au/books?id=lNt6bdfoyxQC&lpg=PA15&dq=The+flow+experience+and+its+significance+for+human+psychology&pg=PA15&redir_esc=y#v=onepage&q&f=false)) - including our negative thoughts. This is obvious to anyone who has tried having two conversations at once or got lost in time while playing chess or another mentally exhausting game.

Flow theory stipulates 3 conditions that must be met in order to be in a flow state:

1. The activity must have a clear set of goals and progress
2. The task must have clear and immediate feedback on how well you are doing
3. There must be a good balance between the perceived challenges of the task and their own perceived skills

![flow chart](/images/happiness/flow.png)
...
As we saw for the life satisfaction, regardless of the majority of the life events that occur, most people return back to a "setpoint" of happiness. We return back to our setpoint relatively quickly after an even of pleasure or pain, or even major life events, and we spend a lot of time in that setpoint. But the set points that people return back to aren't the same - different people have different setpoints ([ref](https://www.ncbi.nlm.nih.gov/pubmed/16719675)). What this hints at is that improving our setpoint is potentially a large-impact way of improving our happiness, as it will have huge cumulative gains over our life.
...
But what exactly is the role that our genes have on our moods and reports? All genes do is encode proteins, and so there must be a chemical difference between the people that have a higher setpoint versus a lower setpoint. The main culprit for the longest time has been the neurotransmitter _serotonin_. I'm not qualified enough to know whether this research still stands, but apparently serotonin was the culprit to the extent that when they found the a specific gene that encoded for serotonin, a variant of it was called the _[depression gene](https://www.ncbi.nlm.nih.gov/pubmed/12161658)_. More accurately, it's a gene that transports serotonin (ie "serotonin transporter gene") called SLC6A4. And even more accurately, it's not the gene itself but the "5-HTTLPR polymorphrism in the promotor region of that gene". Individuals who carried this polymorphism were more vulnerable to depression following exposure to stressful life events ([ref](http://www.ncbi.nlm.nih.gov/pubmed/12869766)), with the events being employment, financial, housing, health, and relationship stressors, along with stressful early life events. This gene X environment ([ref](http://brainworldmagazine.com/the-new-new-genetics-gets-practical/)) interaction explains why stressful events leads to depression in some people but not others.

By understanding the neurochemical differences in people with different setpoints, perhaps we can take it within our control to improve our setpoint. In fact, some researchers have even suggested that we give anti-depressant drugs to healthy individuals to do just that - in what is called '[cosmetic pharmacology](https://en.wikipedia.org/wiki/Cosmetic_pharmacology)' or what I like to call "neurohedonism". If it works for depressed people to get them from -6 to -3, why not use it on the non-depressed to get them from 3 to 6? This is just another case of performance enhancement - just like we use supplements to help our athletic performance, why not take supplements that improve our wellbeing?

We already know for a fact the importance of biology in various mood disorders and it's usefulness for treatment. As a few examples: how much physical intimacy one receives as a child as a big predict for later life mood disorders ([ref](http://www.ncbi.nlm.nih.gov/pubmed/11523842)), the strong positive effects of engaging in regular exercise on depression ([ref](https://en.wikipedia.org/wiki/Physical_exercise#Depression)), the ability of excessive pornography to deplete one's reward system ([ref](http://www.yourbrainonporn.com/adolescent-brain-meets-highspeed-internet-porn)), the importance of delaying gratification and how it's moderated by serotonin levels ([ref](http://www.ncbi.nlm.nih.gov/pubmed/18434531)), how an omega 3 deficiency can result in mood disorders ([ref](https://www.ncbi.nlm.nih.gov/pubmed/16741195)), how getting a massage increases serotonin and dopamine and decreases cortisol ([ref](https://www.ncbi.nlm.nih.gov/pubmed/16162447)), the role of [sleep](https://adamdemirel.com/sleep/) in mood disorders, serotonin can be increased with blue light / exercise / and meditation ([ref](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2077351/?report=classic)).
...
- Cortisol and Glucocorticoids are heavily implemented in the stress response ([ref](https://www.goodreads.com/book/show/327.Why_Zebras_Don_t_Get_Ulcers))
- Dopamine is involved in arousal, motivation, positive reinforcement, and reward perception. Low levels result in depression and lack of motivation. It's implicated in mood ([ref](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4449495/)), but more interestingly it is believed that high dopamine is associated with positive affect ([ref](https://www.ncbi.nlm.nih.gov/pubmed/10467897), [ref](https://en.wikipedia.org/wiki/Positive_affectivity#Research_and_findings))
- Serotonin is involved in sleep, appetite, mood, and feelings of wellbeing. Low levels result in depression. It's implicated in mood ([ref](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4449495/))
- Norepinephrine and Epinephrine are responsible for alertness, wakefulness, arousal, and focus. Norepinephrine is implicated in mood ([ref](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4449495/))
- Opioids / Endorphins / Dynorphin
- Substance P is a pain neurotransmitter
...
This is really oversimplified neurochemistry, and it would be stupid to suggest that you go about _maximizing_ the "good ones" and _minimizing_ the "bad ones", as they have functional roles which would be detrimental if removed. But it does raise the interesting question of which are better/good and which are worse/bad, and how to improve and reduce them, and which neurotransmitters are implicated in well-being. After all, it is very real that you can take certain drugs and attain extremely high positive effect for short periods of time.

You could take ritalin, adderall, mdma, heroin, opioids, coffee ([ref](https://www.ncbi.nlm.nih.gov/pubmed/2465516)), dexamphetamines, cigarettes, [you name it](https://www.erowid.org/). Or you could take those anti-depressants like I mentioned in cosmetic pharmacology - wellbutrin (NDRI), prozac (SSRI), etc. And you'd feel great for a short period of time.

Beyond the safety of drugs, the problem is what we all know which is you build up a tolerance to drug use. The receptors in your brain become less sensitive to the drug and you continually need more and more of the drug to receive the same mood boost. Obviously this is not sustainable long-term to maximize happiness over a lifespan. The actual mechanism of this '_downregulation_' is that as you increase the signaling of a neurotransmitter (ie release), it binds to the receiving receptor which then decreases how much of the receptor is created. The way that it does this is three-fold: if there is too much signalling then the receiving cell can actually die ([ref](https://www.reddit.com/r/neuro/comments/4ochrr/question_what_is_the_neurotransmitter_feedback/), [ref](http://www.scholarpedia.org/article/Homeostatic_Regulation_of_Neuronal_Excitability)), it can prevent more of the transmitter or receptor being made, or it can actively remove the existing receptors from the cell membrane.
...
- Dopamine uses the amino acid l-phenylalanine as a precursor and b6, b12, SAMe, and vitamin C as cofactors which gets converted into -> l-tyrosine -> l-dopa -> and then into dopamine.
- Serotonin uses the amino acid l-tryptophan as a precursor and b6 and b9 as cofactors which gets converted into 5-htp and then serotonin.
- Norepinephrine uses dopamine as a precursor and vitamin c and b6 as cofactors.
- Epinephrine uses norepinephrine as a precursor and SAME / b6 as cofactors.
- Acetylcholine uses the nutrient choline as a precursor and b6 as a cofactor.
- GABA uses the amino acid l-glutamine as a precursor and b6 as a cofactor

So perhaps we can shift the balance of our neurotransmitters by upping the precursors and cofactors needed to make the neurotransmitters that we desire more of? This will work for a short amount of time. It turns out that for neurotransmitter systems, the opioid, gamma-aminobutyric, and endocannibinoid systems in the nucleus accumbens, ventral pallidum, and orbitofrontal cortex are what mediate the perception of rewards ([ref](https://en.wikipedia.org/wiki/Anhedonia#Neurobiological_correlates)). It turns out that dopamine is more related to learning and motivation, but opiates are what actually constitute the reward. If you block opiate function in the brain, net affect greatly increases ([ref](https://www.ncbi.nlm.nih.gov/pubmed/18923027)). Your endogenous / internal levels of opiates are what determines your hedonic set point ([ref](https://www.ncbi.nlm.nih.gov/pubmed/28412878), [ref](https://www.ncbi.nlm.nih.gov/pubmed/14960355)).

Obviously this doesn't mean we should all become _opioid users_, we're all aware of the tragic effects of the current opioid epidemic ([ref](https://theoutline.com/post/2205/this-38-year-old-study-is-still-spreading-bad-ideas-about-addiction?zd=1&zi=hrptgtjf)) and how addictive it is. Now we know why - it is the biological definition of rewarding.

Unfortunately regardless of whether you directly increase the release of neurotransmitters with recreational drugs, whether you prevent the destroyal and reuptake of them with antidepressant drugs, or whether you promote the creation of more neuotransmitters, it turns out that your genes have still set an arbitrary threshold on your neurotransmitters and they will continually return to a homeostatic level ([ref](https://www.reddit.com/r/neurology/comments/4npwjt/question_what_is_the_neurotransmitter_feedback/)). One except may be that vitamin D levels regulate the speed of serotonin synthesis in your body ([ref](https://www.ncbi.nlm.nih.gov/pubmed/24558199)), and is assisted by omega 3s ([ref](https://www.ncbi.nlm.nih.gov/pubmed/25713056)).

There's other factors besides neurotransmitters of potential importance. Another standout factor is brain structure. There's a positive association between the volume of gray matter (in the right precuneus area) and subjective wellbeing ([ref](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4653620/)), with the [prefrontal cortex](https://en.wikipedia.org/wiki/Prefrontal_cortex) ([ref](https://www.ncbi.nlm.nih.gov/pubmed/30385816)), [orbitofrontal cortex](https://en.wikipedia.org/wiki/Orbitofrontal_cortex) and [dorsolateral cortex](https://en.wikipedia.org/wiki/Dorsolateral_prefrontal_cortex) being involved in the experience of pleasure ([ref](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3253139/)). Other evidence suggests that the presence of positive affect vs negative affect is determined by the balance of activity between the left and right frontal hemispheres of the brain ([ref](https://www.ncbi.nlm.nih.gov/pubmed/1389117)). Or that hedonic tone (basically setpoint) is associated with 'left supero-lateral medial forebrain bundle microstructure' ([ref](https://www.ncbi.nlm.nih.gov/pubmed/25124530)).

Unfortunately most of these structures aren't easily modified as you would imagine. The one area where there is promise is the research showing how meditation can lead to a significant gray matter increase within the precuneus ([ref](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4306280/), [ref](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4653620/), [ref](https://www.ncbi.nlm.nih.gov/pubmed/24705269), [ref](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2840837/), [ref](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3004979/), [ref](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3004979/), [ref](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4994843/)). Not only that but meditation also improves some neurotransmitters we want and reduces others ([ref](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4769029/), [ref](https://commons.clarku.edu/cgi/viewcontent.cgi?article=1017&context=surj), [ref](https://www.sciencedirect.com/science/article/abs/pii/S0306987703001750), [ref](https://sahajaonline.com/science-health/mental-health-well-being/neurochemicals/evidence-of-meditations-impact-on-neurotransmitters-neurohormones/)).
...
The methods that most people use to solve this question are either by relying on their [own experience](https://en.wikipedia.org/wiki/Folk_psychology) (informally via trial and error or formally as self-experimentation) or looking at the happiness stories of other people (in stories, movies, art, conversation, observation, etc). As we've seen throughout this essay, they are wholly dubious methods and instead we should rely on the scientific method to figure out using large sample sizes and carefully defined terms and interventions what constitutes this slippery term happiness.

The scientific method uses a systematic set of observations as an attempt to quantify and arrive at answers which go beyond a single person, and in a more standardised manner. Such tools are valuable because they can overcome biases / blind spots individuals may have by using [larger datasets of information](https://en.wikipedia.org/wiki/Law_of_large_numbers). There are a handful of scientific tools that can be used - questionnaires, brain scans, facial expressions, and others. The simple questionnaire has dominated a lot of the happiness research on the assumption that people know how they feel when they say so. Obviously this is wrong in some cases, but it is correct in others. We are lucky that we now no longer need to rely on introspecting or making conjectures about happiness, but have the ability to peruse the large body of literature on the subject.

The main drawback of relying on our personal experience is that we often [lack awareness](https://en.wikipedia.org/wiki/Introspection_illusion) into what makes us feel good and bad, and even if we know we don't usually crystallize in language which is helpful for deciding we want more or less of it.
...
But oddly, if you try to create a 'perfect day' based on a duration and intensity weighted assessment of the above findings, what you get is an odd and unrealistic day where you are doing 15 different activities, where you have sex for 2 hours, then socialize, relax, eat, pray, exercise, shop, and watch TV for 1h, and work for only 36 minutes ([ref](https://www.sciencedirect.com/science/article/abs/pii/S0167487012001158)).
